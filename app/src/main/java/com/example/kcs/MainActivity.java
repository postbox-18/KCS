            ...
            public void onChanged(Integer integer) {
                ...
                switch (integer) {
                    case 0:
                        ...
                        break;
                    case 1:
                        MyLog.e(TAG, "Data>>fun list>>" + new GsonBuilder().setPrettyPrinting().create().toJson(myViewModel.getFunList()));
                        fragment = new HeaderFragment((myViewModel.getFunList()), (myViewModel.getHeaderLists()), (myViewModel.getGetHeaderFragment()));
                        fragmentManager.beginTransaction().replace(R.id.Fragment, fragment).commit();
                        break;
                    case 2:
                        MyLog.e(TAG, "Data>>header list>>" + new GsonBuilder().setPrettyPrinting().create().toJson(myViewModel.getHeaderList()));
